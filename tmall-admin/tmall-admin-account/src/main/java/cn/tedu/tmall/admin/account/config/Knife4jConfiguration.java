...
public class Knife4jConfiguration {
    ...
    /**
     * 【重要】指定Controller包路径,这是我们需要改的，写父类的就可以了
     */
    private static final String BASE_PACKAGE = "cn.tedu.tmall.admin.account";
    /**
     * 组名
     */
     ...
     * 标题
     */
    private static final String TITLE = "学茶商城-账号管理后台服务-在线API文档";
    /**
     * 简介
     */
    private static final String DESCRIPTION = "学茶商城-账号管理后台服务-在线API文档";
    /**
     * 服务条款URL
     */
